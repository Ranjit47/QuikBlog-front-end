    ...
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-screen overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded '>
        ...
        <label htmlFor="image">
          ...
          className='mt-2 h-15 rounded cursor-pointer' alt="" />
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          <button type='button' onClick={generateContent} className='absolute bottom-1 right-2 ml-2 text-sx text-white bg-black/70 px-4 py-1.5 rounded hover:underline cursor-pointer'>Generate with AI </button>
        </div>
        ...
        <div className='flex gap-2 mt-4'>
          <p>Publish Now </p>
          <input type="checkbox" checked={isPublished} className='scale-125 cursor-pinter' onChange={e => setIsPublished(e.target.checked)} />
        </div>
